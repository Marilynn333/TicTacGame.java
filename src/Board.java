...
public class Board {
     ...
     // printBoardRow method will build a string representing the state of the matrix row
    // If there is a 0 in the matrix, it means the cell is empty.
    //If the cell contains a 1, it means there is an X piece in that cell, so it will attach an X to our final row string.
       ...
       // two methods to place game pieces, randomly or in a given position//*

       // the below will place a piece in a given position
    ...
    //The code above will place a game piece in any remaining free cell
